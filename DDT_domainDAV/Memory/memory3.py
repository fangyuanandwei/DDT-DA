...
class Memory(nn.Module):
    ...
    def featuredistance2center(self,feature_source,label_source):
        ...
        feature_source = F.normalize(feature_source)
    ...
    def update_target(self, feature, index_target, label_target):
        ...
        if self.momentum:
            momentum = 0.1
            self.target_featurememory[index_target] = (1.0 - momentum) * self.target_featurememory[index_target] + \
                                                      momentum * feature.data
        else:
    ...
    def sourcefeature2differertcenter(self,source_feature,source_label):
        ...
        source_feature = F.normalize(source_feature)
    ...
    def feature_smiliarity(self, image_target, index_target,label_target,class_model):
        ...
        feature_target = F.normalize(feature_target)
