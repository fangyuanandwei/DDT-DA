...
def train(train_source_iter: ForeverDataIterator, train_target_iter: ForeverDataIterator,
    ...
    for i in range(args.iters_per_epoch):
        ...
        losses.update(loss, image_s.size(0))
...
if __name__ == '__main__':
    ...
    save_dir = './Memory3_banchmark_MultiGPU/CDAN_memory3/Memory_{}_{}_{}_{}/save/Classification_{}_{}'.format(
    ...
    log_dir = './Memory3_banchmark_MultiGPU/CDAN_memory3/Memory_{}_{}_{}_{}/log/Classification_{}_{}'.format(
        args.dataset, args.method,
        args.day, args.time,
        args.source, args.target
    )
    ...
    domain_discri = DomainDiscriminator(in_feature=classifier.features_dim * args.num_class, hidden_size=1024)
