...
def train(train_source_iter: ForeverDataIterator, train_target_iter: ForeverDataIterator,
          ...
          lr_scheduler: StepwiseLR, epoch: int, args: argparse.Namespace, writer):
...
if __name__ == '__main__':
    ...
    #     args.root_path = '/media/wgq/data/DA_data/office31/'
    # if args.dataset == 'officehome':
    #     args.root_path = '/media/wgq/data/DA_data/OfficeHome/'
    # if args.dataset == 'CLEF':
    #     args.root_path = '/media/wgq/data/DA_data/Image_CLEF/'
    ...
    # writer_center = SummaryWriter(os.path.join(log_dir,'runs/writer_center'))
    # writer_Inter = SummaryWriter(os.path.join(log_dir,'runs/writer_Inter'))
    # writer_InterThre = SummaryWriter(os.path.join(log_dir,'runs/writer_InterThre'))
    # writer_fileter = SummaryWriter(os.path.join(log_dir,'runs/writer_fileter'))
    #SummaryWriter
