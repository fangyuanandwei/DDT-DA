...
if __name__ == '__main__':
    ...
    save_dir = './Memory1_banchmark_part/CDAN_memory1_Part/Memory_{}_{}_{}_{}/save/Classification_{}_{}'.format(
    ...
    log_dir = './Memory1_banchmark_part/CDAN_memory1_Part/Memory_{}_{}_{}_{}/log/Classification_{}_{}'.format(
        args.dataset, args.method,
        args.day, args.time,
        args.source, args.target
    )
