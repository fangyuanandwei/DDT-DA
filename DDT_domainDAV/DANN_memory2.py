...
def train(train_source_iter: ForeverDataIterator, train_target_iter: ForeverDataIterator,
    ...
    for i in range(args.iters_per_epoch):
        ...
        if epoch == 0:
            ...
            centerloss = torch.tensor(0).cuda()
            memoryloss = torch.tensor(0).cuda()
        else:
            Memory.update_center(feature_s, labels_s, None)
            Memory.featuredistance2center(feature_s, labels_s)
            Memory.sourcefeature2differertcenter(feature_s, labels_s)
            centerloss = Memory.feature2center(feature_s,labels_s)
        ...
        loss = cls_loss + transfer_loss * args.trade_off + memoryloss + centerloss
        ...
        if i % 100 == 0:
            print('Epoch[{}/{}][{}/{}],Cls_loss:{:.4f}, Transfer_loss:{:.4f},Centerloss:{:.4f},Memoryloss:{:.4f}'.format(
                epoch,args.max_epoch,
                i,args.iters_per_epoch,
                cls_loss.item(), transfer_loss.item(), centerloss.item(), memoryloss.item()
            ))
...
if __name__ == '__main__':
    ...
    save_dir = './Result/MemoryResult_DomainAdv/Memory_{}_{}_{}_{}/Classification_{}_{}'.format(
    ...
    log_dir = './Result/MemoryResult_DomainAdv/Memory_{}_{}_{}_{}/log/Classification_{}_{}'.format(
        args.dataset, args.method,
        args.day, args.time,
        args.source, args.target
    )
