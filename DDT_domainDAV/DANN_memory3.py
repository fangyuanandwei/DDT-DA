...
if __name__ == '__main__':
    ...
    save_dir = './Memory3_banchmark/DANN_memory3/Memory_{}_{}_{}_{}/save/Classification_{}_{}'.format(
    ...
    log_dir = './Memory3_banchmark/DANN_memory3/Memory_{}_{}_{}_{}/log/Classification_{}_{}'.format(
        args.dataset, args.method,
        args.day, args.time,
        args.source, args.target
    )
